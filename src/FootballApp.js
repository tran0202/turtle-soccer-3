              ...
              <h2>Teams</h2>
                <Row>
                  ...
                  <Col xl="4" lg="5" md="6" sm="8" xs="8" className="text-left">
                    <p>The National Football League (NFL) is a professional American football league consisting of 32 teams, divided equally between the National Football Conference (NFC) and the American Football Conference (AFC)</p>
                  </Col>
                </Row>
            </div>
            ...
            <Row>
              <Col lg="12">
                <ul id="fblteam-flters">
                  ...
                  <li data-filter=".filter-AFC-East" className="col-2">AFC East</li>
                  <li data-filter=".filter-AFC-North" className="col-2 offset-1">AFC North</li>
                  <li data-filter=".filter-AFC-South" className="col-2 offset-1">AFC South</li>
                  <li data-filter=".filter-AFC-West" className="col-2 offset-1">AFC West</li>
                  <li data-filter=".filter-NFC-East" className="col-2">NFC East</li>
                  <li data-filter=".filter-NFC-North" className="col-2 offset-1">NFC North</li>
                  <li data-filter=".filter-NFC-South" className="col-2 offset-1">NFC South</li>
                  <li data-filter=".filter-NFC-West" className="col-2 offset-1">NFC West</li>
                </ul>
              </Col>
            </Row>
