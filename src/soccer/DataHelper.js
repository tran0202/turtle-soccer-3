...
export const getCurrentTournament = () => {
  return { tournament: 'COPA1999', qualificationTournament: 'WC2022_CONMEBOL' }
}
...
export const getTournamentDataCOPA = () => {
  return [].concat([td_COPA_2001], [td_COPA_2004], [td_COPA_2007], [td_COPA_2011], [td_COPA_2015], [td_COPA_2016], [td_COPA_2019])
}
