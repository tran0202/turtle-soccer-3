...
import t_UEL from '../data/soccer/tournament/t_UEL.json'
...
import td_MOFT_1928 from '../data/soccer/tournamentData/MOFT/td_MOFT_1928.json'
import td_MOFT_1936 from '../data/soccer/tournamentData/MOFT/td_MOFT_1936.json'
import td_MOFT_1948 from '../data/soccer/tournamentData/MOFT/td_MOFT_1948.json'
import td_MOFT_1952 from '../data/soccer/tournamentData/MOFT/td_MOFT_1952.json'
import td_MOFT_1956 from '../data/soccer/tournamentData/MOFT/td_MOFT_1956.json'
import td_MOFT_1960 from '../data/soccer/tournamentData/MOFT/td_MOFT_1960.json'
import td_MOFT_1964 from '../data/soccer/tournamentData/MOFT/td_MOFT_1964.json'
import td_MOFT_1968 from '../data/soccer/tournamentData/MOFT/td_MOFT_1968.json'
import td_MOFT_1972 from '../data/soccer/tournamentData/MOFT/td_MOFT_1972.json'
...
import td_MOFT_1992 from '../data/soccer/tournamentData/MOFT/td_MOFT_1992.json'
import td_MOFT_1996 from '../data/soccer/tournamentData/MOFT/td_MOFT_1996.json'
import td_MOFT_2000 from '../data/soccer/tournamentData/MOFT/td_MOFT_2000.json'
import td_MOFT_2004 from '../data/soccer/tournamentData/MOFT/td_MOFT_2004.json'
import td_MOFT_2008 from '../data/soccer/tournamentData/MOFT/td_MOFT_2008.json'
import td_MOFT_2012 from '../data/soccer/tournamentData/MOFT/td_MOFT_2012.json'
import td_MOFT_2016 from '../data/soccer/tournamentData/MOFT/td_MOFT_2016.json'

import td_WOFT_1996 from '../data/soccer/tournamentData/WOFT/td_WOFT_1996.json'
import td_WOFT_2000 from '../data/soccer/tournamentData/WOFT/td_WOFT_2000.json'
import td_WOFT_2004 from '../data/soccer/tournamentData/WOFT/td_WOFT_2004.json'
...
import td_UNL_202021 from '../data/soccer/tournamentData/UNL/td_UNL_202021.json'
...
import td_COPA_1919 from '../data/soccer/tournamentData/COPA/td_COPA_1919.json'
import td_COPA_1920 from '../data/soccer/tournamentData/COPA/td_COPA_1920.json'
import td_COPA_1921 from '../data/soccer/tournamentData/COPA/td_COPA_1921.json'
import td_COPA_1922 from '../data/soccer/tournamentData/COPA/td_COPA_1922.json'
...
import td_COPA_1927 from '../data/soccer/tournamentData/COPA/td_COPA_1927.json'
import td_COPA_1929 from '../data/soccer/tournamentData/COPA/td_COPA_1929.json'
import td_COPA_1935 from '../data/soccer/tournamentData/COPA/td_COPA_1935.json'
import td_COPA_1937 from '../data/soccer/tournamentData/COPA/td_COPA_1937.json'
import td_COPA_1939 from '../data/soccer/tournamentData/COPA/td_COPA_1939.json'
import td_COPA_1941 from '../data/soccer/tournamentData/COPA/td_COPA_1941.json'
import td_COPA_1942 from '../data/soccer/tournamentData/COPA/td_COPA_1942.json'
import td_COPA_1945 from '../data/soccer/tournamentData/COPA/td_COPA_1945.json'
import td_COPA_1946 from '../data/soccer/tournamentData/COPA/td_COPA_1946.json'
import td_COPA_1947 from '../data/soccer/tournamentData/COPA/td_COPA_1947.json'
import td_COPA_1949 from '../data/soccer/tournamentData/COPA/td_COPA_1949.json'
import td_COPA_1953 from '../data/soccer/tournamentData/COPA/td_COPA_1953.json'
import td_COPA_1955 from '../data/soccer/tournamentData/COPA/td_COPA_1955.json'
import td_COPA_1956 from '../data/soccer/tournamentData/COPA/td_COPA_1956.json'
import td_COPA_1957 from '../data/soccer/tournamentData/COPA/td_COPA_1957.json'
import td_COPA_1959ARG from '../data/soccer/tournamentData/COPA/td_COPA_1959ARG.json'
import td_COPA_1959ECU from '../data/soccer/tournamentData/COPA/td_COPA_1959ECU.json'
import td_COPA_1963 from '../data/soccer/tournamentData/COPA/td_COPA_1963.json'
import td_COPA_1967 from '../data/soccer/tournamentData/COPA/td_COPA_1967.json'
import td_COPA_1975 from '../data/soccer/tournamentData/COPA/td_COPA_1975.json'
import td_COPA_1979 from '../data/soccer/tournamentData/COPA/td_COPA_1979.json'
import td_COPA_1983 from '../data/soccer/tournamentData/COPA/td_COPA_1983.json'
import td_COPA_1987 from '../data/soccer/tournamentData/COPA/td_COPA_1987.json'
import td_COPA_1989 from '../data/soccer/tournamentData/COPA/td_COPA_1989.json'
import td_COPA_1991 from '../data/soccer/tournamentData/COPA/td_COPA_1991.json'
import td_COPA_1993 from '../data/soccer/tournamentData/COPA/td_COPA_1993.json'
import td_COPA_1995 from '../data/soccer/tournamentData/COPA/td_COPA_1995.json'
import td_COPA_1997 from '../data/soccer/tournamentData/COPA/td_COPA_1997.json'
import td_COPA_1999 from '../data/soccer/tournamentData/COPA/td_COPA_1999.json'
import td_COPA_2001 from '../data/soccer/tournamentData/COPA/td_COPA_2001.json'
import td_COPA_2004 from '../data/soccer/tournamentData/COPA/td_COPA_2004.json'
import td_COPA_2007 from '../data/soccer/tournamentData/COPA/td_COPA_2007.json'
import td_COPA_2011 from '../data/soccer/tournamentData/COPA/td_COPA_2011.json'
import td_COPA_2015 from '../data/soccer/tournamentData/COPA/td_COPA_2015.json'
...
import td_GC_1981 from '../data/soccer/tournamentData/GC/td_GC_1981.json'
import td_GC_1985 from '../data/soccer/tournamentData/GC/td_GC_1985.json'
import td_GC_1989 from '../data/soccer/tournamentData/GC/td_GC_1989.json'
import td_GC_1991 from '../data/soccer/tournamentData/GC/td_GC_1991.json'
import td_GC_1993 from '../data/soccer/tournamentData/GC/td_GC_1993.json'
import td_GC_1996 from '../data/soccer/tournamentData/GC/td_GC_1996.json'
import td_GC_1998 from '../data/soccer/tournamentData/GC/td_GC_1998.json'
import td_GC_2000 from '../data/soccer/tournamentData/GC/td_GC_2000.json'
import td_GC_2002 from '../data/soccer/tournamentData/GC/td_GC_2002.json'
import td_GC_2003 from '../data/soccer/tournamentData/GC/td_GC_2003.json'
import td_GC_2005 from '../data/soccer/tournamentData/GC/td_GC_2005.json'
import td_GC_2007 from '../data/soccer/tournamentData/GC/td_GC_2007.json'
import td_GC_2009 from '../data/soccer/tournamentData/GC/td_GC_2009.json'
import td_GC_2011 from '../data/soccer/tournamentData/GC/td_GC_2011.json'
import td_GC_2013 from '../data/soccer/tournamentData/GC/td_GC_2013.json'
import td_GC_2015 from '../data/soccer/tournamentData/GC/td_GC_2015.json'
...
import td_AFCON_1957 from '../data/soccer/tournamentData/AFCON/td_AFCON_1957.json'
import td_AFCON_1959 from '../data/soccer/tournamentData/AFCON/td_AFCON_1959.json'
import td_AFCON_1962 from '../data/soccer/tournamentData/AFCON/td_AFCON_1962.json'
import td_AFCON_1963 from '../data/soccer/tournamentData/AFCON/td_AFCON_1963.json'
import td_AFCON_1965 from '../data/soccer/tournamentData/AFCON/td_AFCON_1965.json'
import td_AFCON_1968 from '../data/soccer/tournamentData/AFCON/td_AFCON_1968.json'
import td_AFCON_1970 from '../data/soccer/tournamentData/AFCON/td_AFCON_1970.json'
import td_AFCON_1972 from '../data/soccer/tournamentData/AFCON/td_AFCON_1972.json'
import td_AFCON_1974 from '../data/soccer/tournamentData/AFCON/td_AFCON_1974.json'
import td_AFCON_1976 from '../data/soccer/tournamentData/AFCON/td_AFCON_1976.json'
import td_AFCON_1978 from '../data/soccer/tournamentData/AFCON/td_AFCON_1978.json'
import td_AFCON_1980 from '../data/soccer/tournamentData/AFCON/td_AFCON_1980.json'
import td_AFCON_1982 from '../data/soccer/tournamentData/AFCON/td_AFCON_1982.json'
import td_AFCON_1984 from '../data/soccer/tournamentData/AFCON/td_AFCON_1984.json'
import td_AFCON_1986 from '../data/soccer/tournamentData/AFCON/td_AFCON_1986.json'
import td_AFCON_1988 from '../data/soccer/tournamentData/AFCON/td_AFCON_1988.json'
import td_AFCON_1990 from '../data/soccer/tournamentData/AFCON/td_AFCON_1990.json'
import td_AFCON_1992 from '../data/soccer/tournamentData/AFCON/td_AFCON_1992.json'
import td_AFCON_1994 from '../data/soccer/tournamentData/AFCON/td_AFCON_1994.json'
import td_AFCON_1996 from '../data/soccer/tournamentData/AFCON/td_AFCON_1996.json'
import td_AFCON_1998 from '../data/soccer/tournamentData/AFCON/td_AFCON_1998.json'
import td_AFCON_2000 from '../data/soccer/tournamentData/AFCON/td_AFCON_2000.json'
import td_AFCON_2002 from '../data/soccer/tournamentData/AFCON/td_AFCON_2002.json'
import td_AFCON_2004 from '../data/soccer/tournamentData/AFCON/td_AFCON_2004.json'
import td_AFCON_2006 from '../data/soccer/tournamentData/AFCON/td_AFCON_2006.json'
import td_AFCON_2008 from '../data/soccer/tournamentData/AFCON/td_AFCON_2008.json'
import td_AFCON_2010 from '../data/soccer/tournamentData/AFCON/td_AFCON_2010.json'
import td_AFCON_2012 from '../data/soccer/tournamentData/AFCON/td_AFCON_2012.json'
import td_AFCON_2013 from '../data/soccer/tournamentData/AFCON/td_AFCON_2013.json'
import td_AFCON_2015 from '../data/soccer/tournamentData/AFCON/td_AFCON_2015.json'
...
import td_ACC_1956 from '../data/soccer/tournamentData/AAC/td_AAC_1956.json'
import td_ACC_1960 from '../data/soccer/tournamentData/AAC/td_AAC_1960.json'
import td_ACC_1964 from '../data/soccer/tournamentData/AAC/td_AAC_1964.json'
import td_ACC_1968 from '../data/soccer/tournamentData/AAC/td_AAC_1968.json'
import td_ACC_1972 from '../data/soccer/tournamentData/AAC/td_AAC_1972.json'
import td_ACC_1976 from '../data/soccer/tournamentData/AAC/td_AAC_1976.json'
import td_ACC_1980 from '../data/soccer/tournamentData/AAC/td_AAC_1980.json'
import td_ACC_1984 from '../data/soccer/tournamentData/AAC/td_AAC_1984.json'
import td_ACC_1988 from '../data/soccer/tournamentData/AAC/td_AAC_1988.json'
import td_ACC_1992 from '../data/soccer/tournamentData/AAC/td_AAC_1992.json'
import td_ACC_1996 from '../data/soccer/tournamentData/AAC/td_AAC_1996.json'
...
import td_ONC_1973 from '../data/soccer/tournamentData/ONC/td_ONC_1973.json'
import td_ONC_1980 from '../data/soccer/tournamentData/ONC/td_ONC_1980.json'
import td_ONC_1996 from '../data/soccer/tournamentData/ONC/td_ONC_1996.json'
...
import td_ONC_2008 from '../data/soccer/tournamentData/ONC/td_ONC_2008.json'
...
export const getCurrentTournament = () => {
  return { tournament: 'UEL202021', qualificationTournament: 'WC2022_CONMEBOL' }
}

export const getTournamentArray = () => {
  return t_WC.concat(t_WWC, t_MOFT, t_WOFT, t_CONFEDC, t_EURO, t_UNL, t_UCL, t_UEL, t_COPA, t_GC, t_AFCON, t_AAC, t_ONC)
}
...
export const getTournamentDataUEL = () => {
  return [].concat([td_UEL_201819], [td_UEL_201920])
}
