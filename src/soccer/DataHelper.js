...
export const getCurrentTournament = () => {
  return { tournament: 'EURO1984', qualificationTournament: 'WC2022_CONMEBOL' }
}
...
export const getTournamentDataEURO = () => {
  return [].concat([td_EURO_1988], [td_EURO_1992], [td_EURO_1996], [td_EURO_2000], [td_EURO_2004], [td_EURO_2008], [td_EURO_2012], [td_EURO_2016])
}
