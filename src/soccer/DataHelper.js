...
export const getCurrentTournament = () => {
  return { tournament: 'AFCON2010', qualificationTournament: 'WC2022_CONMEBOL' }
}
...
export const getTournamentDataAFCON = () => {
  return [].concat([td_AFCON_2012], [td_AFCON_2013], [td_AFCON_2015], [td_AFCON_2017], [td_AFCON_2019])
}
