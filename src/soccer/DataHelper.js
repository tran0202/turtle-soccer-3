...
export const getCurrentTournament = () => {
  return { tournament: 'GC2005', qualificationTournament: 'WC2022_CONMEBOL' }
}
...
export const getTournamentDataGC = () => {
  return [].concat([td_GC_2007], [td_GC_2009], [td_GC_2011], [td_GC_2013], [td_GC_2015], [td_GC_2017], [td_GC_2019])
}
